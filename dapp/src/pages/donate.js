                                ...
                                <div className="row flex-lg-row-reverse align-items-center g-5">
                                    <div className="col-7">
                                        {
                                            campaign.videoUrl
                                                ...
                                                // eslint-disable-next-line @next/next/no-img-element ssd
                                    ...
                                    <div className="col-5 mb-5" style={{ height: 480, scrollbars: true }}>
                                        ...
                                        <p className="mb-3 fst-italic mt-5">
                                            E aí, o que achou do projeto? Já foi arrecadado 0 BNB nesta campanha. O quanto você quer doar (em BNB)?
                                        </p>
                                        <div className="mb-3">
